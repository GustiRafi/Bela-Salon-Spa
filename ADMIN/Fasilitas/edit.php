            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <form action="" class="mt-3" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <img width="200px" class="rounded-3" src="../../img/<?php echo $fasilitas['foto'] ?>">
                        </div>

                        <div class="mb-3">
                            <input type="hidden" class="form-control" name="oldphoto" id="oldphoto"
                                value="<?php echo $fasilitas["foto"] ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            <textarea name="deskripsi" class="form-control" id="deskripsi" rows="3"
                                placeholder="Deskripsi" required><?= $fasilitas['deskripsi'] ?></textarea>
                        </div>
