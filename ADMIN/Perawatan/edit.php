...
$layanan = query("SELECT * FROM layanan WHERE id_layanan = $id")[0];

if(isset($_POST["edit"])){
    if(edit_threat($_POST) > 0 ){
        echo "
            <script>
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="perawatan.php">Data Layanan / Jasa</a>
                        <a class="collapse-item" href="../Fasilitas/fasilitas.php">Fasilitas</a>
                        <a class="collapse-item" href="add.php">Tambah Layanan / Jasa</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Pelayanan</h1>
                    </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Kategori"
                                value="<?php echo $layanan['nama_layanan'] ?>" require>
                        </div>

                        <div class="mb-3">
                            <input type="text" class="form-control" name="desk" id="desk" placeholder="Deskripsi"
                                value="<?php echo $layanan['deskripsi'] ?>" require>
                        </div>

                        <div class="mb-3">
                            <input type="text" class="form-control" name="harga" id="harga" placeholder="Harga"
                                value="<?php echo $layanan['harga'] ?>" require>
                        </div>
