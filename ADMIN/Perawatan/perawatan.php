...
$layanan = query("SELECT * FROM layanan ORDER BY id_layanan DESC");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    <a href="add.php"><button type="submit" class="btn btn-outline-primary">Tambah
                            Pelayanan</button></a>
                    ...
                    <table class="table table-striped responsive mt-4 w-100 text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?php echo $row['id_layanan'] ?>"
                                    class="btn btn-outline-success"><i class="bi bi-pencil-square me-3"></i>Edit</a>
                                <a href="delate.php?id=<?php echo $row['id_layanan'] ?>" onclick="
