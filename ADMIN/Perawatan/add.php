            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Layanan Perawatan</h1>
                    </div>

                    <form action="" method="post">
                        <div class="mb-3">
                            <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Perawatan"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-outline-primary" name="add">Tambah</button>
                        </div>
                    </form>
                </div>
            </div>
